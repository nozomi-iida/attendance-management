...
describe("PageLayout",  () => {
  test("logout", async() => {
    ...
    render(<Router location={history.location} navigator={history}><CurrentAccountContext.Provider value={{account, setAccount: jest.fn}}><PageLayout><div /></PageLayout></CurrentAccountContext.Provider></Router>)
